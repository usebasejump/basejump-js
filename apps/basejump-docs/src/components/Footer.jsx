...
import { GitHubIcon, TwitterIcon } from '@/components/Icons.jsx'
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      ...
      <div className="flex gap-4">
        <SocialLink href="https://twitter.com/tiniscule" icon={TwitterIcon}>
...
export function Footer({ showFeedbackForm = true }) {
  let router = useRouter()

  return (
    <footer className="mx-auto w-full max-w-2xl space-y-10 pb-16 lg:max-w-5xl">
      {showFeedbackForm && <Feedback key={router.pathname} />}
      <PageNavigation />
      <SmallPrint />
    </footer>
  )
